...
$aviso = "<a class='close-session' href='login.html'>Login</a>";
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['email']) && isset($_POST['pass'])) {
        ...
        if (!user($email, $password)) {
            ...
            $aviso = "<h2 style='font-size: 24px; color: green;'>¡Bienvenido $email!</h2> <a class='close-session' href='form_MySQL.php?logout=true'>Cerrar Sesión</a>";
        }
    }
}
